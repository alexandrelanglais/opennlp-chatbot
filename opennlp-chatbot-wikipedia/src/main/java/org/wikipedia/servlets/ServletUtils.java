...
public class ServletUtils {
   /**
    * Sanitizes untrusted input for XSS destined for inclusion in the HTML body.
    * 
    * @param input
    *           an input string
   ...
   /**
    * Sanitizes untrusted input for XSS destined for inclusion in boring HTML
    * attributes.
    * 
    * @param input
   ...
   /**
    * Sanitizes untrusted input for XSS destined for inclusion in URLs. (Note that
    * most Wiki.java methods should handle this.)
    * 
    * @param input
    *           the input to be sanitized
    * @see <a href="https://www.owasp.org/index.php/XSS_Prevention"> OWASP XSS
