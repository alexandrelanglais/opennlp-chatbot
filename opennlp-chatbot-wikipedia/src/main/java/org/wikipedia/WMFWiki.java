...
public class WMFWiki extends Wiki {
    ...
    * 
    * @param domain
    *           a WMF wiki domain name e.g. en.wikipedia.org
    */
   ...
   public static WMFWiki[] getSiteMatrix() throws IOException {
      ...
      wiki.setMaxLag(0);
      String line = wiki.fetch("https://en.wikipedia.org/w/api.php?format=xml&action=sitematrix",
            "WMFWiki.getSiteMatrix");
      ArrayList<WMFWiki> wikis = new ArrayList<WMFWiki>(1000);

      // form: <special url="http://wikimania2007.wikimedia.org" code="wikimania2007"
      // fishbowl="" />
    ...
    * 
    * @param title
    *           the title of the page (must contain "File:")
    * @return the global usage of the file, including the wiki and page the file is
    *         used on
    * @throws IOException
    *            if a network error occurs
    * @throws UnsupportedOperationException
    *            if <tt>namespace(title) != FILE_NAMESPACE</tt>
    */
