...
/**
 * Various parsing methods that e.g. turning Wiki.java objects into wikitext and
 * HTML and vice versa.
 * 
 * @author MER-C
 * @version 0.02
...
public class ParserUtils {
   /**
    * Standard markup for RevDeleted stuff. (The class name,
    * <tt>history-deleted</tt> comes from MediaWiki.)
    */
   private static final String DELETED = "<span class=\"history-deleted\">deleted</span>";

   /**
    * Parses a list of links into its individual elements. Such a list should be in
    * the form:
    *
    * <pre>
    *  * [[Main Page]]
   ...
   /**
    * Formats a list of pages, say, generated from one of the query methods into
    * something that would be editor-friendly. Does the exact opposite of
    * <tt>parseList()</tt>, i.e. { "Main Page", "Wikipedia:Featured picture
    * candidates", "File:Example.png" } becomes the string:
    *
    * <pre>
    *  *[[:Main Page]]
    *  *[[:Wikipedia:Featured picture candidates]]
    ...
    * slowness may result when copying large amounts of wikitext produced by this
    * method, or by the wiki trying to parse it. Takes the form of:
    *
    * <p>
    ...
    * 
    * @param wiki
    *           the parent wiki of the revisions
    * @param revisions
    *           the revisions to convert
    * @return (see above)
    ...
    *           the results to render
    * @param domain
    *           the domain that was searched (should already be sanitized for XSS)
    * @param wiki
    *           the wiki that was searched
