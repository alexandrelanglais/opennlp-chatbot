...
public class AllWikiLinksearch {
   ...
   /**
    * The top 20 Wikimedia projects, namely { "en", "de", "fr", "nl", "it", "pl",
    * "es", "ru", "ja", "pt", "zh", "sv", "vi", "uk", "ca", "no", "fi", "cs", "hu",
    * "fa" }.wikipedia.org.
    */
    ...
    * "ro", "ko", "ar", "tr", "id", "sk", "eo", "da", "sr", "kk", "lt", "ms", "he",
    * "bg", "eu", "sl", "vo", "hr", "war", "hi" }.wikipedia.org.
    */
   ...
   public static void main(String[] args) throws IOException {
      ...
      if (domain != null)
         domain = JOptionPane.showInputDialog(null, "Enter domain to search", "All wiki linksearch",
   ...
   public static synchronized void writeOutput(String output) {
      try {
         ...
         // shouldn't happen
         JOptionPane.showMessageDialog(null, "Error writing to file!", "All wiki linksearch",
    ...
    * @param ns
    *           restrict to the given namespaces
    * @return the linksearch results, as in wiki => results
    * @throws IOException
    *            if a network error occurs
    */
   public static Map<Wiki, List[]> crossWikiLinksearch(String domain, Wiki[] wikis, boolean https, boolean mailto,
