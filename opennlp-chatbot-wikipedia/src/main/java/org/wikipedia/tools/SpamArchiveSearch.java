...
public class SpamArchiveSearch {
   ...
   /**
    * Searches the following spam-related discussion archives for the given query
    * string:
    * 
    * <ul>
    ...
    * <li><a href=
    * "//en.wikipedia.org/wiki/MediaWiki_talk:Spam-whitelist">en.wikipedia spam
    * whitelist</a>
    * <li><a href="//en.wikipedia.org/wiki/WT:WPSPAM">en.wikipedia WikiProject
    * Spam</a>
    * <li><a href="//en.wikipedia.org/wiki/WP:RSN">en.wikipedia reliable sources
    * noticeboard</a>
    * <li><a href="//en.wikipedia.org/wiki/WP:ELN">en.wikipedia external links
    * noticeboard</a>
    * </ul>
    * 
