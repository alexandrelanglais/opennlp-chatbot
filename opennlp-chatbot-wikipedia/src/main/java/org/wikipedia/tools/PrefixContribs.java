...
/**
 * Fetches contributions from an IP address range or a group of users that have
 * a common prefix. Offline version of
 * org/wikipedia/servlets/prefixcontribs.jsp.
 * 
 * @author MER-C
 * @version 0.01
 */
public class PrefixContribs {
    ...
    * 
    * @param args
    *           the command line arguments (none expected)
    * @throws IOException
