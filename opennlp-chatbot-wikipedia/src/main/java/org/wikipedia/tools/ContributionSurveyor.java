...
public class ContributionSurveyor {
    ...
    * 
    * @param homewiki
    *           the wiki to survey on
    * @param users
    *           the users to survey
    * @param output
    *           the output file to write to
    * @param userspace
    *           whether to survey output
    * @param images
    *           whether to survey images (searches Commons as well)
    * @throws IOException
    *            if a network error occurs
    * @since 0.02
    */
   public static void contributionSurvey(Wiki homewiki, String[] users, File output, boolean userspace, boolean images)
         throws IOException {
    ...
    *         Commons by the user, third element = images transferred to Commons
   ...
   /**
    * Performs a survey of a user's deleted contributions. Requires administrator
    * access to the relevant wiki. (Note: due to MediaWiki limitations, it is not
    * possible to filter by bytes added or whether an edit created a new page.)
    * 
    * @param homewiki
    *           the user's home wiki
    * @param username
    *           the user to survey
    * @param ns
    *           the namespaces to survey (not specified = all namespaces)
    * @throws IOException
    *            if a network error occurs
    * @throws CredentialNotFoundException
    *            if one cannot view deleted pages
    * @since 0.03
    */
