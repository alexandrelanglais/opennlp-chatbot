...
public class GUIUtils {
   ...
   /**
    * Shows a JOptionPane with the stacktrace/backtrace for the Throwable passed
    * in. Useful in GUI applications.
    * 
    * @param e
    *           The Throwable object to print a stack trace for
    */
   ...
   /**
    * Creates a form in the form of a JPanel. Fields are dynamically resized when
    * the window size is modified by the user.
    * 
    * @param title
    *           Title to use in the border. Specify null if you don't want one.
    *           Specify empty string if you want just border.
    * @param cl
    *           The list of containers to work with. Elements should be in the
    *           order, e.g. JLabel1, JTextField1, JLabel 2, JTextField2, etc.
    * 
    ...
    * Program is exited if user cancels/closes the dialog box.
    * 
    * @param starting
    *           Starting directory. If you want to use the user's home directory, I
    *           suggest using <tt>System.getProperty("user.home")</tt>
    * @return A list of Files representing directories the user selected.
    * @throws IllegalArgumentException
    *            If the solitary param is non-existent or not a directory.
    */
    ...
    * 
    * @param s
    *           The string to make into a label.
    * @return The JLabel.
    */
