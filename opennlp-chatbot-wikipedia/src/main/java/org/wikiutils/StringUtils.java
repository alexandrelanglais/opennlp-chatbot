...
public class StringUtils {
    ...
    * 
    * @param text
    *           main body of text to check.
    * @param s2
    *           we will try to check if s2 is contained in text.
    * 
   ...
   /**
    * Parses a String, assumed to be a list, into a String array. Each item in the
    * list must be separated by a newline character. Space characters are ignored.
    * The ignore list is case sensitive, and only checks if each String in the list
    * starts with the specified text; this is useful for parsing out comments
    * and/or unwanted crap.
    * 
    * @param s
    *           The String to use (must be delimited by new line chars)
    * @param prefix
    *           Adds a prefix to the beginning of each element. Specify "" for no
    *           prefix.
    * @param ignorelist
    *           If an item in the list contains a String in this list, it won't be
    *           included in the final result. Whatever you do, don't put an empty
    *           string in here; you'll be sorry :3
    */
    ...
    * 
    * @param fn
    *           The filename to parse (e.g. Example.jpg)
    * @return The extension of the file, without the "." Returns null if this file
    *         has no extension.
    * @see #getFileExt(File)
    */
