...
public class WikiUtils {
    ...
    * e.g. <tt>listNamespaceSort(list, WIKI.FILE_NAMESPACE, wiki);</tt>
    * 
    * @param wiki
    *           The wiki object to use.
    * @param ns
    *           The namespace filter. Items in this namespace shall be returned.
    * @param pages
    *           The titles (including namespace) to check.
    * 
    ...
    *           The array to use
    * @param reason
    *           The reason to use while deleting
    * @param talkReason
    *           The reason to use when deleting talk pages of the pages we're
    *           deleting. Specify "null" if talk pages are not to be deleted
    * @param wiki
    *           The wiki object to use.
    * 
      ...
      for (String s : list) {
         ...
         if (talkReason != null) {
            try {
               ...
               // We'll probably only be here if we tried to delete a talk page of a talk page
               // :P
            }
         }
    ...
    * 
    * @param find
    *           The text to be found. You can use a regex for this
    * @param replacement
    *           The text to replace any text matching the <tt>find</tt> field
    * @param summary
    *           The edit summary to use
    * @param wiki
    *           The wiki object to use
    * @param pages
    *           The wiki pages to act upon.
    */
   ...
   /**
    * Performs null edit on a list of pages by wiki. PRECONDITION: wiki object must
    * be logged in
    * 
    * @param wiki
    *           The wiki object to use
    * @param l
    *           The list of pages to null edit.
    */
    ...
    *           The wiki object to use
    * @param cat
    *           Category name, with or without "Category:" prefix, in any language,
    *           is fine.
    * 
