...
public class LoginUtils {
   ...
   /**
    * Generic login method which turns off maxlag and throttle. Catches
    * IOExceptions 8 times, and then exits program.
    * 
    * @param wiki
    *           Wiki object to perform changes on
    * @param user
    *           User to login as, without "User:" prefix
    * @param p
    *           User's password, in the form of a char array.
    * 
    */
   ...
   /**
    * Login with loginAndSetPrefs(), but using a GUI. Throttle auto-set to 12
    * edits/min.
    * 
    * @param wiki
    *           Wiki object to perform changes on
   ...
   /**
    * Creates and shows user a login screen, returning user login details in a
    * String array. Does not check to see if login details are valid.
    * 
    * @param title
   ...
   public static String[] showLoginScreen(String title) {
      ...
      if (JOptionPane.showConfirmDialog(null,
            GUIUtils.buildForm(title, new JLabel("Username:", JLabel.TRAILING), u, new JLabel("Password:",
                  JLabel.TRAILING), px),
