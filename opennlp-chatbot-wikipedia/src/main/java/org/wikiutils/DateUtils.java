...
public class DateUtils {
   ...
   /**
    * Returns a Gregorian Calendar offset by a given number of days from the
    * current system clock. Use positive int to offset by future days and negative
    * numbers to offset to days before. Automatically set to UTC.
    * 
    * @param days
    *           The number of days to offset by -/+. Use 0 for no offset.
    * 
    ...
    * 
    * @param format
    *           Must be specified in accordance with java.text.DateFormat.
    * @param offset
    *           The offset from the current time, in days. Accepts positive values
    *           (for future), negative values (for past), and 0 for no offset.
    * 
